...
// Publishes a cylinder marker representing the vehicle's footprint/safety radius.
...
// Publishes an arrow marker showing the vehicle's heading.
...
// Publishes cylinder markers for each static obstacle.
...
// Publishes markers tracing the vehicle's predicted/planned trajectory.
